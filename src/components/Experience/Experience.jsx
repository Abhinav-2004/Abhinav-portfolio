...
const Experience = () => {
  return (
    <section
      id="experience"
      className="pb-24  font-sans bg-skills-gradient clip-path-custom-2"
    >
      {/* Section Title */}
      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => (
          ...
          >
            ...
            {/* Content Section */}
            <div
              className={`content-section w-full sm:max-w-md p-4 sm:p-8 rounded-2xl shadow-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] ${
